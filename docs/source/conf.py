...
sys.path.insert(0, os.path.abspath('../../mkstuff'))
...
project = u'mkstuff'
copyright = u'2019, Martin Kilbinger'
author = u'Martin Kilbinger'
...
latex_documents = [
    (master_doc, 'mkstuff.tex', u'mkstuff Documentation',
     u'Martin Kilbinger', 'manual'),
]
...
man_pages = [
    (master_doc, 'mkstuff', u'mkstuff Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mkstuff', u'mkstuff Documentation',
     author, 'mkstuff', 'Useful but random python routines.',
     'Miscellaneous'),
]
